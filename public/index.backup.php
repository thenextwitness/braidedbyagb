...
<header class="sp-nav" id="site-header">
  <div class="sp-nav-inner">
    <a href="/" class="sp-logo"><img src="/assets/images/braidedbyagblogo.png"></a>
...
<section class="sp-section sp-services" id="services">
  <div class="sp-container">
    <p class="sp-label">What We Offer</p>
    <h2 class="sp-title">Our Services</h2>
    <p class="sp-lead">Every style crafted with precision and care using premium techniques.</p>
...
<section class="sp-section sp-testimonials" id="testimonials">
  <div class="sp-container">
    <p class="sp-label">Testimonials</p>
    <h2 class="sp-title">What Our Clients Say</h2>
    <p class="sp-lead">Don't just take our word for it. Here's what our satisfied clients have to say about their experience with us.</p>
...
<section class="sp-section sp-contact" id="contact">
  <div class="sp-container">
    <p class="sp-label">Contact Us</p>
    <h2 class="sp-title">Have a question? We'd love<br>to hear from you.</h2>
