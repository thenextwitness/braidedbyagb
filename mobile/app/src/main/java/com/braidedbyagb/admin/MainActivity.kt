...
import com.braidedbyagb.admin.ui.screens.gallery.GalleryScreen
...
object GalleryRoute    { const val route = "gallery_admin" }
...
fun AppRoot(
    ...
    val selectedTab = when {
        ...
        currentRoute == GalleryRoute.route                  -> Screen.Settings.route
        ...
        NavHost(
            ...
            composable(Screen.Settings.route) {
                SettingsScreen(
                    ...
                    onManageGallery   = { navController.navigate(GalleryRoute.route) }
                )
            }
            ...
            composable(GalleryRoute.route)   { GalleryScreen(onBack = { navController.popBackStack() }) }
